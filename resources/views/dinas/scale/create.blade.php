...
@section('title', 'Tambah Skala Usaha - Portal UMKM')
...
<header class="main-header">
    <div class="page-title">Tambah Skala Usaha</div>
    ...
    <div class="card" style="padding: var(--space-6);">
        ...
        <form action="{{ route('dinas.scale.store') }}" method="POST" id="form-create-scale" dusk="scale-form">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" class="input-field" value="{{ old('name') }}" placeholder="Contoh: Mikro, Kecil, Menengah" required dusk="scale-name">
                @error('name')
            ...
            <div class="mb-6">
                ...
                <textarea name="description" id="description" class="input-field" rows="4" placeholder="Deskripsi singkat skala usaha (opsional)" style="resize: vertical;" dusk="scale-description">{{ old('description') }}</textarea>
                @error('description')
            ...
            <div class="flex gap-3">
                <button type="submit" class="btn btn-brand" id="btn-simpan" dusk="scale-submit">
